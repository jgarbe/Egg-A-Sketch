...
#    print("path:", path)
    ...
    print("Servo Up SI Line 620 Following Path")
...
def connect_closest_black_pixel(image, yDest, xDest, s):
    ...
    #next, then down if left is not a border, then right if down is not a border
    #NOTE: This is a wek algorithm since you could have a peninsula one pixel thin pointing
    ...
    stepIndex = 3  #Initial value means will check up first at starting point
    done = False
    debug = False
...
#Returns True if stopped early, False if completed image
    ...
    while not done:
        ...
        os.system('sudo /home/pi/EAS/servo_down')
        print("Servo Down SI Line 819 Shade")

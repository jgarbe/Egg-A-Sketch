...
def reset_origin(hMotor, vMotor, inputDict):
    ...
    print("Pulling Servo Up. EAS Line 89 Position")
    ...
    vMotor.go_to(400)
    vMotor.go_to(0)
    os.system('sudo /home/pi/EAS/servo_down')
    print("Putting Servo Down. EAS Line 97 Backlash")
    os.system('sudo /home/pi/EAS/servo_up')
    print("Pulling Servo Up. EAS Line 99 Backlash")
    hMotor.turn_off()
    vMotor.turn_off()
...
def run_harmonograph(hMotor, vMotor, inputDict):
    ...
    os.system('sudo /home/pi/EAS/servo_up')
    print("Pulling Servo Up. EAS Line 122 Positioning")
    hMotor.go_to(hPos)
    vMotor.go_to(vPos)
    os.system('sudo /home/pi/EAS/servo_down')
    print("Putting Servo Down. EAS Line 126 Positioning")
...
#    eMotor.turn_off()
    ...
    vMotor.turn_off()
    os.system('sudo /home/pi/EAS/servo_up')
    print("Pulling Servo Up. EAS Line 187 Stopping with decay")
...
#    print("inputDict:", inputDict)
    ...
    os.system('sudo /home/pi/EAS/servo_up')
    print("Pulling Servo Up. EAS Line 222 Starting Postitioning")
    hMotor.go_to(x1Init + x2Init)
    vMotor.go_to(y1Init + y2Init)
    os.system('sudo /home/pi/EAS/servo_down')
    print("Putting Servo Down EAS Line 227 Starting Positioning")
    #Erase the harmonograph
#    eMotor.set_motorStepInc(10000)
#    eMotor.set_clockwise(False)
#    print("Erasing the EAS!")
...
#    eMotor.turn_off()
    ...
    vMotor.turn_off()
    os.system('sudo /home/pi/EAS/servo_up')
    print("Pulling Servo Up. EAS Line 248 Finished Harmonograoph")
...
def draw_image(hMotor, vMotor, inputDict):
    ...
    xMotor = bs.stepper(2, 4, 3, 17, _name='horiz', _backlash=hBacklash)
    yMotor = bs.stepper(27, 10, 22,  9, _name='vert', _backlash=vBacklash)
    ...
    os.system('sudo /home/pi/EAS/servo_up')
    print("Pulling Servo Up. EAS Line 378 Starting Positioning")
    yMotor.go_to(yStart*si.pixelSizeY)
    xMotor.go_to(xStart*si.pixelSizeX)
    os.system('sudo /home/pi/EAS/servo_down')
    print("Putting Servo Down. EAS Line 381 Starting Positioning")
#    eMotor.set_motorStepInc(10000)
#    eMotor.set_clockwise(False)
#    eraser.erase(eMotor, eraseSpeed, 1024, 7.5, numShakes, 0.4)
#    eMotor.turn_off()
...
hMotor = sc.stepper(2, 4, 3, 17, _name='horiz', _backlash=hBacklash)
vMotor = sc.stepper(27, 10, 22,  9, _name='vert', _backlash=vBacklash)
#eMotor = sc.stepper(14, 15, 18, 23, _name='erase', _backlash=0)
...
os.system('sudo /home/pi/EAS/servo_down')
print("Pulling Servo Down. EAS Line 427 Initializing")
os.system('sudo /home/pi/EAS/servo_up')
print("Pulling Servo Up. EAS Line 428 Initializing")
